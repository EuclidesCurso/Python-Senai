...
fig_prod = px.bar(df_filter, x="Date", y="Product line", color="City", barmode="group", title="Faturamento por tipo de produto")
...
fig_kind = px.pie(df_filter, values="Total", names="Payment", title="Faturamento por tipo pagamento")
